...
export const EXERCISE_EXACT_MATCHES: Record<string, string> = {
  ...
  'Front pulldown': 'lever front pulldown',
  'Wide-grip pulldown': 'cable wide grip rear pulldown behind neck',
  'Assisted pull-up': 'assisted pull-up',
  'Face pull': 'cable face pull',
  'Machine row': 'lever seated row',
  'Machine front pulldown': 'lever front pulldown',
  'Shrug': 'barbell shrug',
  ...
  'Light leg press': 'sled 45° leg press',
  'Sumo squat': 'barbell sumo squat',
  'Dumbbell deadlift': 'dumbbell deadlift',
  'Machine glute': 'barbell glute bridge',
  'Abductor': 'lever seated hip abduction',
...
export const EXERCISE_FALLBACK_OPTIONS: Record<string, string[]> = {
  ...
  'Machine chest press': ['lever chest press', 'lever incline chest press', 'lever decline chest press', 'machine inner chest press'],
  ...
  'Seated row': ['cable seated row', 'lever seated row', 'cable rope seated row'],
  'Front pulldown': ['lever front pulldown', 'cable pulldown', 'lever front pulldown'],
  'Assisted pull-up': ['assisted pull-up', 'pull up (neutral grip)', 'lever front pulldown'],
  ...
  'Leg press': ['sled 45° leg press', 'sled 45 degrees one leg press', 'lever seated squat calf raise on leg press machine'],
  'Romanian deadlift': ['barbell romanian deadlift', 'dumbbell romanian deadlift', 'barbell straight leg deadlift'],
  'Leg curl': ['seated leg curl', 'machine leg curl', 'hamstring curl'],
  'Machine glute': ['barbell glute bridge', 'lever reverse hyperextension', 'cable standing hip extension'],
  'Abductor': ['lever seated hip abduction', 'side hip abduction', 'cable hip adduction'],
